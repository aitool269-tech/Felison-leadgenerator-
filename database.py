...
CREATE TABLE IF NOT EXISTS leads(
    ...
    website TEXT,
    telefoon TEXT, email TEXT, contactpersoon TEXT, contactpersoon_functie TEXT,
    overvoerpotentie TEXT, huidige_aanbieder TEXT, overvoerpotentie_premie REAL,
...
CREATE TABLE IF NOT EXISTS leads(
    ...
    website TEXT,
    telefoon TEXT, email TEXT, contactpersoon TEXT, contactpersoon_functie TEXT,
    overvoerpotentie TEXT, huidige_aanbieder TEXT, overvoerpotentie_premie DOUBLE PRECISION,
    vervolg_datum TEXT, vervolg_actie TEXT,
    presentje_datum TEXT, presentje_type TEXT,
    relatie_match TEXT, relatie_naam TEXT, relatie_bron TEXT,
    status TEXT DEFAULT 'Nieuw',
...
MIGRATIES = [
    ...
    "ALTER TABLE leads ADD COLUMN contactpersoon_functie TEXT",
    "ALTER TABLE leads ADD COLUMN overvoerpotentie TEXT",
    "ALTER TABLE leads ADD COLUMN huidige_aanbieder TEXT",
    "ALTER TABLE leads ADD COLUMN overvoerpotentie_premie REAL",
